...
//             <h2 className="text-4xl font-bold text-[#0d4544] mb-4">Popular Destinations</h2>
    ...
    <div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-black px-4 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight text-white">
            Discover the Beauty of
            <span className="block text-white">Pakistan</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-white max-w-2xl mx-auto">
            From the mighty peaks of K2 to the serene beaches of Karachi, explore Pakistan's diverse landscapes and rich
            culture
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="text-center p-6 rounded-lg border border-gray-200 hover:border-teal-300 hover:shadow-lg transition-all cursor-pointer">
                <div className="flex items-center justify-center w-16 h-16 bg-teal-100 rounded-full mx-auto mb-4">
                  <service.icon className="h-8 w-8 text-teal-600" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">{service.title}</h3>
      ...
      <section id="blog" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Best Time to Visit Northern Pakistan", date: "March 15, 2024", image: "/images/nt.webp?height=200&width=300" },
              { title: "Hidden Gems of Balochistan", date: "March 10, 2024", image: "/images/blochi.webp?height=200&width=300" },
              { title: "Food Guide: Must-Try Pakistani Dishes", date: "March 5, 2024", image: "/images/food.jpg?height=200&width=300" },
            ].map((post, index) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <button onClick={() => router.push("/destinations")} className="hover:text-white transition-colors">Destinations</button>
                </li>
                <li>
                  <button onClick={() => router.push("/services")} className="hover:text-white transition-colors">Services</button>
                </li>
              </ul>
            </div>
